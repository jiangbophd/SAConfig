...
sap.ui.controller("sa.config.controllers.Visit", {
	onInit: function() {
    ...
    handleClose: function(oEvent) {
        ...
        sa.config.util.Utils.handleSlectedDialog(generalVisitData,processTypeSet,'VIS');
     ...
     changeMultipFuntionBox:function(evt){
    	 ...
    	 sa.config.util.Utils.handleOrderMultipFuntion(visitModel,processTypeModel,'VIS',evt);
     },
     /**
      * handle fixed switch
      */
     ...
     changeVisitTextObject:function(evt){
    	 var visitModel = this.getView().getModel('visit');
    	 var processTypeModel = this.getView().getModel("processTypeSet")
    	 sa.config.util.Utils.handleVisitTextObject(visitModel,processTypeModel,'VIS',evt);
     },
     changeSurveyObject:function(evt){
    	 var visitModel = this.getView().getModel('visit');
    	 var processTypeModel = this.getView().getModel("processTypeSet");
    	 sa.config.util.Utils.handleSurveyObject(visitModel,processTypeModel,'VIS',evt);
     },
    /**
     * delete the item
     */
