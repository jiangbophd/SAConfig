...
sap.ui.controller("sa.config.controllers.Opp", {
	onInit: function() {
	...
	getDefaultData:function(){
        ...
        oModel.read("Orders('OPP')/?$format=json&$expand=ProcessTypeSet,ProcessTypeSet/PartnerFunctionSet,ProcessTypeSet/SurveySet,ProcessTypeSet/OrderTextTypeSet", {
    ...
    handleClose: function(oEvent) {
        ...
        sa.config.util.Utils.handleSlectedDialog(generalVisitData,processTypeSet,'OPP');
     ...
     changeMultipFuntionBox:function(evt){
    	 ...
    	 sa.config.util.Utils.handleOrderMultipFuntion(visitModel,processTypeModel,'OPP',evt);
     },
     /**
      * handle fixed switch
      */
     ...
     changeVisitTextObject:function(evt){
    	 var visitModel = this.getView().getModel('visit');
    	 var processTypeModel = this.getView().getModel("processTypeSet")
    	 sa.config.util.Utils.handleVisitTextObject(visitModel,processTypeModel,'OPP',evt);
     },
     changeSurveyObject:function(evt){
    	 var visitModel = this.getView().getModel('visit');
    	 var processTypeModel = this.getView().getModel("processTypeSet");
    	 sa.config.util.Utils.handleSurveyObject(visitModel,processTypeModel,'OPP',evt);
     },
    /**
     * delete the item
     */
