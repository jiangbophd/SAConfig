...
sap.ui.controller("sa.config.controllers.Task", {
	onInit: function() {
	...
	getDefaultData:function(){
        ...
        oModel.read("Orders('TAS')/?$format=json&$expand=ProcessTypeSet,ProcessTypeSet/PartnerFunctionSet,ProcessTypeSet/SurveySet,ProcessTypeSet/OrderTextTypeSet", {
    ...
    handleClose: function(oEvent) {
        ...
        sa.config.util.Utils.handleSlectedDialog(generalVisitData,processTypeSet,'TAS');
     ...
     changeMultipFuntionBox:function(evt){
    	 ...
    	 sa.config.util.Utils.handleOrderMultipFuntion(visitModel,processTypeModel,'TAS',evt);
     },
     /**
      * handle fixed switch
      */
     ...
     changeVisitTextObject:function(evt){
    	 var visitModel = this.getView().getModel('visit');
    	 var processTypeModel = this.getView().getModel("processTypeSet")
    	 sa.config.util.Utils.handleVisitTextObject(visitModel,processTypeModel,'TAS',evt);
     },
     changeSurveyObject:function(evt){
    	 var visitModel = this.getView().getModel('visit');
    	 var processTypeModel = this.getView().getModel("processTypeSet");
    	 sa.config.util.Utils.handleSurveyObject(visitModel,processTypeModel,'TAS',evt);
     },
    /**
     * delete the item
     */
